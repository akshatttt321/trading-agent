...
def config_schema() -> Dict[str, Dict[str, Any]]:
    ...
    S: Dict[str, Dict[str, Any]] = {
        ...
        "llm.manager_interval_min": {"type": "int", "min": 3, "max": 60, "label": "Manager max interval (min)"},
        "llm.manager_min_move_atr15": {"type": "float", "min": 0.1, "max": 3, "label": "Manager wake: move (x 15m ATR)"},
